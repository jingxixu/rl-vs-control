...
class SAC(object):
    ...
    def save_model(self, folder_path):
        ...
        actor_fnm = "actor.pth"
        critic_fnm = "critic.pth"
        actor_path = os.path.join(folder_path, actor_fnm)
        critic_path = os.path.join(folder_path, critic_fnm)
    ...
    def load_model(self, folder_path):
        actor_path = os.path.join(folder_path, 'actor.pth')
